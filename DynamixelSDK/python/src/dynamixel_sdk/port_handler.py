...
class PortHandler(object):
    ...
    def setPacketTimeout(self, packet_length):
        ...
        self.packet_timeout = (self.tx_time_per_byte * packet_length) + (LATENCY_TIMER * 100) + 2.0
        #print(f"PACKET TIMEOUT SET TO: {self.packet_timeout} TX_TIME_PER_BYTE: {self.tx_time_per_byte}")
        #change for error
